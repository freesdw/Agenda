...
User::User(const string& t_userName, const string& t_userPassword, const string& t_userEmail, const string& t_userPhone) {
    m_name = t_userName;
...
void User::setPassword(cosnt string& t_password) {
